...
tl:group('list:remove(e [any]) ->', function()
	...
	tl:test('removes the target element [bool] and reduces inst._len by 1', function()
		local a = list.new()
		a:insert(true)
		a:insert(false)
		assert(a._len == 2)
	...
	tl:test('removes the first element [bool] found in list when there are multiple', function()
		local a = list.new()
		a:insert(true)
		a:insert(false)
		a:insert(true)
...
tl:group('list.__index ->', function()
...
tl:group('list.__newindex ->', function()
